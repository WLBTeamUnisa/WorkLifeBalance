...
public class ShowCalendarHistoryServlet extends HttpServlet {
     ...
     * @pre request.getParameter("employeeEmail")!=null
     * @pre request.getParameter("month")!=null
     * @pre request.getParameter("year")!=null
     * @post request.getAttribute("result")!=null || jsonArray.toString()!=null
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessionEmployee != null) {
            /**
             * If the parameter employeeEmail is null, or empty, it means that the system has to retrieve the calendar
             * history of the employee's session
             * 
             */
            if (employeeString == null || employeeString.equals("")) {
                ...
                JSONArray jsonArray = ShowCalendarHistoryServlet.buildJsonArray(smartWorkingPrenotationList,
                        workstationPrenotationList, month, year);
                response.setContentType("application/json");
                response.getWriter().append(jsonArray.toString());
            } else {
                /**
                 * If the parameter employeeEmail isn't null, or empty, it means that the system has to retrieve the
                 * calendar history of the employee's request
                 */
                try {
    ...
    /**
     * This method build a JsonArray that will contain a list of JSON object with these attributes: date,type,floor,room
     * and workstation
     * 
     * Example: [{"date"="2019-02-01","type"="Workstation",floor"=1,"room"=1,"workstation"=50},
     ...
     * @return JSONArray
     */
    public static JSONArray buildJsonArray(List<SmartWorkingPrenotation> smartWorkingPrenotationList,
            List<WorkstationPrenotation> workstationPrenotationList, Integer month, Integer year) {
