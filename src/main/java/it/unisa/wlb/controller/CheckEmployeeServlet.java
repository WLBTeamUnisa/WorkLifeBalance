...
public class CheckEmployeeServlet extends HttpServlet {
    ...
    /**
     * If the Employee already exists, the response (written in XML) will be <no/>, otherwise it will be <ok/>, meaning
     * that the email is not yet associated with any Employee.
     * 
     * @param request
