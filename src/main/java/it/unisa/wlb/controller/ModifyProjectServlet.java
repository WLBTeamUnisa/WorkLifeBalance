...
public class ModifyProjectServlet extends HttpServlet {
     ...
     * @pre request.getSession().getAttribute("employeeList") != null OR
     *      request.getSession().getAttribute("employeeList") == null
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!managerEmail.equals("") && managerEmail.matches("^[a-z]{1}\\.[a-z]+[1-9]+\\@wlb.it$")
                && manager.getStatus() == 1) {
            managerEmailOk = true;
        }
