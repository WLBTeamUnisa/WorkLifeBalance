...
@NamedQueries({
        ...
        @NamedQuery(name = "SmartWorkingPrenotation.findByEmployee", query = "SELECT s FROM SmartWorkingPrenotation s WHERE s.id.employee = :employee"),
        @NamedQuery(name = "SmartWorkingPrenotation.findByWeeklyPlanning", query = "SELECT s FROM SmartWorkingPrenotation s WHERE s.id.employee = :employee AND s.calendarWeek = :calendarWeek AND s.year = :year") })
...
public class SmartWorkingPrenotation implements Serializable {
    ...
    public String toString() {
        return "SmartWorkingPrenotation [id=" + id + ", calendarWeek=" + calendarWeek + ", year=" + year + ", employee="
                + employee + "]";
    }
}