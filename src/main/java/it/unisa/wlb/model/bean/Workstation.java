...
@NamedQueries({ @NamedQuery(name = "Workstation.findAll", query = "SELECT w FROM Workstation w"),
...
public class Workstation implements Serializable {
     ...
     */
    @ManyToOne
    @JoinColumns(value = { @JoinColumn(name = "NUM_FLOOR", columnDefinition = "int(3)", nullable = false),
