...
public interface IGenericDao<E> {
	 ...
	 * 
	 * @param entity that is meant to be stored into the database
	 ...
	 * 
	 * @param entityClass represents the element that is meant to be removed from the database
	 */
	 ...
	 * 
	 * @param entityClass represents the element that is meant to be updated
