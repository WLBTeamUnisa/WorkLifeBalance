										...
										<div class="container">
											<div class="card col-lg-10 mx-auto">
												<div class="card-header p-2">
													...
													<p class="m-0" style="color:grey"><small>Clicca su un dipendente per visualizzarne lo storico.</small></p>
												</div>
												<div class="card-body">
															...
															<ul class="list-group list-group-bordered"
																...
																<c:forEach items="${project.employees}" var="employee">
																	<li class='list-group-item'><a
																		...
																		style="color: black; text-decoration: none;" class="mx-auto w-100"> <i
