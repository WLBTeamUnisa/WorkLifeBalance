$( document ).ready(function() {
    function c(passed_month, passed_year, calNum) {
        ...
        for(var cell=0;cell<42-r;cell++) { // 42 date-cells in calendar
            if(cell >= calMonthArray.length) {
                ...
                // Later refactiroing -- iter_date not needed after "today" is
				// found
                ...
                confirmButtonText: 'Si, voglio prenotare'
                  ...
                  if(result.value){
                    if(numGiorni.giorni.length>=3){
                      ...
                      // CONTA SE IL #DI DATE SCELTE È MINORE DI 3 E, SE VERO,
						// SALVA LA DATA SCELTA IN UNA
                      // VARIABILE DA MANDARE POI ALLA SERVLET (AJAX) CHE
						// INSERIRÀ TUTTO NEL DB
                      Swal.fire(
                          'Successo!',
                          ...
                          console.log(numGiorni.giorni.length);
                          // numGiorni.push(clicked.html());
                          for(var i = 0; i<numGiorni.giorni.length; i++){
                              console.log(numGiorni.giorni[i]);
                        }
                      }
    ...
    function makeMonthArray(passed_month, passed_year) { // creates Array
															// specifying dates
															// and weekdays
        var e=[];
