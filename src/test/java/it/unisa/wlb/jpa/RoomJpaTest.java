...
class RoomJpaTest {
    ...
    void removeTest() {
        ...
        for (Room aRoom : roomsList) {
            if (aRoom.getId().getNumRoom() == firstRoom.getId().getNumRoom())
                check = false;
        }
        assertTrue(check);
        try {
    ...
    void retrieveByFloorTest() {
        ...
        boolean check = false;
        for (Room aRoom : roomsList) {
            if (aRoom.getFloor().getNumFloor() == firstFloor.getNumFloor())
                check = true;
        }
        assertTrue(check);
    }
    ...
    void retrieveAllTest() {
        ...
        for (Room aRoom : roomsList) {
            if (aRoom.getId().getNumRoom() == firstRoom.getId().getNumRoom())
                checkfirstRoom = true;
            if (aRoom.getId().getNumRoom() == secondRoom.getId().getNumRoom())
                checkSecondRoom = true;
            if (aRoom.getId().getNumRoom() == thirdRoom.getId().getNumRoom())
                checkThridRoom = true;
        }
