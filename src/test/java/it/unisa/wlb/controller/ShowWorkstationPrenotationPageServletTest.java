...
class ShowWorkstationPrenotationPageServletTest {
    ...
    void setUp() throws Exception {
        ...
        workstationPrenotationPk
                .setPrenotationDate(Date.from(nextMonday.atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
    ...
    void yesSmartWorkingPrenotationAndWorkstationPrenotation() throws ServletException, IOException {
        ...
        when(smartWorkingDao.retrieveByWeeklyPlanning(nextCalendarWeek, year, email))
                .thenReturn(smartWorkingPrenotation);
        when(workstationPrenotationDao.retrieveByWeeklyPlanning(nextCalendarWeek, year, email))
