...
class HomeServletTest {
    ...
    void setUp() throws Exception {
        ...
        workstationPrenotationPk
                .setPrenotationDate(Date.from(monday.atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()));
    ...
    void homeServletSuccess() throws ServletException, IOException {
        ...
        when(workstationPrenotationDao.retrieveByWeeklyPlanning(calendarWeek, year, email))
