...
/**
 * This test class follows the specification of the section "3.5.2 TC_5.2 Prenota giorni di Smart Working" of the
...
public class SmartWorkingDaysPrenotationServletTest extends Mockito {
    ...
    public void TC_5_2_1() throws ServletException, IOException {
        ...
        try {
            ...
            assertTrue(response.getStatus() == HttpServletResponse.SC_BAD_REQUEST
                    && response.getContentAsString().toString().contains(message));
        }
    }
    ...
    public void TC_5_2_3() throws ServletException, IOException {
        ...
        when(smartWorkingDao.retrieveByWeeklyPlanning(nextCalendarWeek, year, smartWorking.getEmployee().getEmail()))
                .thenReturn(smartWorking);
