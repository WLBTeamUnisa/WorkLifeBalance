...
public class LoginServletTest {
    ...
    /**
     * TC_4.1_1: email.length() &lt; 5. It should be email.length &gt;= 5 and email.length &lt;=30 - FAIL
     * 
    ...
    /**
     * TC_4.1_2: email.length() &gt; 30. It should be email.length &gt;= 5 and email.length &lt;=30 - FAIL
     * 
     * @throws ServletException
     * @throws IOException
     */
    ...
    /**
     * TC_4.1_3: email doesn't respect format. The formats that should be respected are: -
     * [a-z]{1}\.[a-z]+[0-9]*\@wlb.it - [a-z]{1}\.[a-z]+[0-9]*\@wlbadmin.it) - FAIL
     * 
     * @throws ServletException
     * @throws IOException
     */
    ...
    public void TC_4_1_4() throws ServletException, IOException {
        ...
        Mockito.when(eDao.retrieveByEmailPassword(email, Utils.generatePwd(password)))
    ...
    /**
     * TC_4.1_5: password doesn't respect the format. The format is not respected - FAIL
     * 
     * @throws ServletException
     * @throws IOException
     */
    ...
    public void TC_4_1_6() throws ServletException, IOException {
        ...
        Mockito.when(employeeDao.retrieveByEmailPassword(email, Utils.generatePwd(password)))
                .thenThrow(new NoResultException());
    ...
    public void TC_4_1_8() throws ServletException, IOException {
        ...
        IEmployeeDao employeeDao = mock(IEmployeeDao.class);
        Mockito.when(employeeDao.retrieveByEmailPassword(employee.getEmail(), employee.getPassword()))
                .thenReturn(employee);
