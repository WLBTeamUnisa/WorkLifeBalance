...
/**
 * This test class follows the specification of the section "3.5.1 TC_5.1 Prenota postazione di lavoro" of the document "Test Case Specification"
 * 
...
public class WorkstationPrenotationServletTest extends Mockito {
	...
	public void TC_3_1_4() throws ServletException, IOException {
		...
		when(workstationDao.retrieveById(existingFloor, existingRoom, existingWorkstation)).thenThrow(IllegalArgumentException.class, NoResultException.class, NonUniqueResultException.class, IllegalStateException.class, QueryTimeoutException.class, TransactionRequiredException.class, PessimisticLockException.class, LockTimeoutException.class, PersistenceException.class);				
	...
	public void TC_3_1_9() throws ServletException, IOException {
		...
		when(workstationPrenotationDao.create(workstationPrenotation)).thenThrow(IllegalArgumentException.class, NoResultException.class, NonUniqueResultException.class, IllegalStateException.class, QueryTimeoutException.class, TransactionRequiredException.class, PessimisticLockException.class, LockTimeoutException.class, PersistenceException.class);				
